        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float node_5892 = 0.0;
                    float node_5937 = 1.0;
                    float3 node_4429 = ((_StartNrmDispMinMaxStr.g + ( (_StartDisplacement_var.rgb - node_5892) * (_StartNrmDispMinMaxStr.b - _StartNrmDispMinMaxStr.g) ) / (node_5937 - node_5892))*_StartNrmDispMinMaxStr.a*v.normal);
                    v.vertex.xyz += node_4429;
                }
                float Tessellation(TessVertex v){
                    ...
                    return ((node_4115*node_5892)+_Tesselation);
                }
...
///////// Gloss:
                ...
                float node_4372 = (_StartRoughness_var.r*_StartRoughMult);
                float gloss = 1.0 - node_4372; // Convert roughness to gloss
                float perceptualRoughness = node_4372;
...
////// Specular:
                ...
                float3 node_6343 = (_MainTex_var.rgb*_StartColor.rgb);
