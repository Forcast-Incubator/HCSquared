...
////// Emissive:
                ...
                float3 emissive = (node_5482.rgb*pow(1.0-max(0,dot(normalDirection, viewDirection)),_FresnelAngle)*(_FresnelStrength*saturate((-1*dot(node_5661,normalDirection)))));
